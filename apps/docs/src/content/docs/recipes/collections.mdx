...
<Aside type="caution">
  You cannot delete a collection that is referenced by a published product. Archive or unpublish the product first.
</Aside>
...
<Aside type="tip">
  Create a collection before you start building a product. It is much easier to organize recipe order in the collection view than in the product builder.
</Aside>
