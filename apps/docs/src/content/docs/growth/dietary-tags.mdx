...
<Aside type="caution">
  If you change a recipe's ingredients, any confirmed dietary tags will be reset to unconfirmed. You will need to review and re-confirm them.
</Aside>
...
<Aside type="tip">
  Batch-confirming tags is fast. Go through your imported recipes and confirm tags in bulk — it takes just a few seconds per recipe and unlocks the full power of audience segmentation.
</Aside>
