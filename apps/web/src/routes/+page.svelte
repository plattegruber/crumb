...
{:else}
	<div class="landing">
		<div class="landing-content">
			...
			<p class="description">
				Import your recipes, build digital products, grow your email list
				with dietary segmentation, and understand what content drives
				engagement.
			</p>
			<div class="cta-buttons">
				<a href="/sign-up" class="btn btn-primary btn-lg">Get Started</a>
				<a href="/sign-in" class="btn btn-lg">Sign In</a>
			</div>
		</div>
	</div>
{/if}
