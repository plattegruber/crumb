...
<Aside type="caution">
  You must review and approve all AI-generated copy before publishing. crumb marks it as
...
<Aside>
  If rendering fails (for example, due to a font loading issue), crumb falls back to system fonts
