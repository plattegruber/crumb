...
<div class="settings-subpage">
	...
	<p class="page-description">Connect your Kit (ConvertKit) account to enable subscriber segmentation, automation, and product publishing.</p>
	...
	<div class="card">
		...
		<button class="btn btn-primary" disabled>Connect Kit Account</button>
		<p class="coming-soon">OAuth flow is under development.</p>
	</div>
</div>
