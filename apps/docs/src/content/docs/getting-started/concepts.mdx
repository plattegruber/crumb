---
title: Core concepts
description: Understand the building blocks of dough — recipes, collections, products, segments, and automations.
---
...
<Aside>
  dough never generates recipes with AI. AI is used only to *extract* recipes from external sources,
