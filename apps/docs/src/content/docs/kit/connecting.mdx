...
<Aside>
  All permissions are required. If you decline any scope, crumb will not be able to function
  correctly and will prompt you to re-authorize with all scopes.
</Aside>
...
<Aside type="caution">
  Disconnecting does not remove tags or custom fields that crumb already created in your Kit
  account. Those remain in Kit and can be managed directly in Kit's interface.
</Aside>
