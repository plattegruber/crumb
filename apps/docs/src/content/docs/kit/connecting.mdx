...
description: Connect dough to Kit via OAuth and understand the required permissions.
---
...
<Aside>
  All permissions are required. If you decline any scope, dough will not be able to function
...
<Aside type="caution">
  Disconnecting does not remove tags or custom fields that dough already created in your Kit
