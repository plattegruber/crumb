...
<Aside>
  dough never sends emails without your approval. It creates drafts that you review and schedule
  yourself inside Kit.
</Aside>
...
<Tabs>
  <TabItem label="From a URL">
    ...
    the URL of a recipe page from your blog or any recipe website. 4. Click **Import**. dough will
  ...
  <TabItem label="From Instagram">
    ...
    dough will extract the recipe from the caption text. 5. Review and edit the extracted recipe,
...
<Aside type="tip">
  dough automatically suggests dietary tags (like Gluten-Free or Vegan) based on your ingredients.
...
- **Import more recipes** — the more recipes in your library, the more useful dough becomes. Try [bulk importing from Instagram](/recipes/importing/) or [syncing your WordPress recipes](/settings/wordpress/).
...
- **Explore segmentation** — as subscribers interact with your recipe cards, dough builds dietary preference segments. Learn about [how segmentation works](/growth/segmentation/).
