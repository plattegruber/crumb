  ...
  <form class="recipe-form" onsubmit={handleSubmit}>
    ...
    <div class="form-section">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input id="prep-minutes" type="number" bind:value={prepMinutes} placeholder="0" min="0" />
        </div>
        <div class="form-group">
          <label for="cook-minutes">Cook (minutes)</label>
          <input id="cook-minutes" type="number" bind:value={cookMinutes} placeholder="0" min="0" />
        </div>
      </div>
    </div>
    ...
    <div class="form-section">
      <div class="form-group">
        ...
        <textarea id="notes" bind:value={notes} placeholder="Additional notes" rows="3"></textarea>
      </div>
    </div>
