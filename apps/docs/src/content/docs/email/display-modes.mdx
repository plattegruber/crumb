...
<Aside type="tip">
  If you are unsure which mode to choose, start with Standard. It works well in most situations and gives subscribers enough information to decide whether to save the recipe.
</Aside>
