...
Ebooks are the flagship product type in crumb. You select a collection of recipes, crumb helps you organize them into chapters with intro copy, and the result is a professionally formatted PDF and EPUB cookbook styled with your brand.
...
crumb analyzes your selected recipes and suggests chapter groupings based on:
...
<Aside type="tip">
  You do not have to use the AI suggestion. If you already know how you want to organize your ebook, skip it and create your own chapter structure.
</Aside>

### 4. AI intro and headnote copy

Once chapters are set, crumb generates:
...
<Aside type="caution">
  You must review and approve all AI-generated copy before publishing. crumb marks it as "unreviewed" and blocks publishing until you confirm each section.
</Aside>
...
- **Template** — choose from crumb's template library. Templates use your brand kit colors and fonts automatically.
...
Click **Generate**. crumb renders the ebook as both PDF and EPUB. This process takes up to 2 minutes depending on the number of recipes.

When rendering completes, the files are stored on your product record and available for download, preview, and publishing.

<Aside>
  If rendering fails (for example, due to a font loading issue), crumb falls back to system fonts and notifies you. You can retry at any time.
</Aside>
...
Once your ebook is ready, you can generate a free lead magnet from it. crumb selects the top 3-5 recipes by engagement score, creates a condensed PDF, and sets up a Kit opt-in form and delivery sequence automatically.
