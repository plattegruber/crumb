...
<div class="automation-page">
  ...
  {:else}
    ...
    <section class="auto-section">
      ...
      <div class="card">
        <p class="coming-soon">
          Automatically create Kit broadcast drafts when you publish a new recipe. Configuration
          coming soon.
        </p>
      </div>
    </section>
    ...
    <section class="auto-section">
      ...
      <div class="card">
        <p class="coming-soon">
          Automatically create Kit sequences for lead magnet delivery. Configuration coming soon.
        </p>
      </div>
    </section>
  {/if}
