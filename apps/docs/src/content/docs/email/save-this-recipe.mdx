...
Every recipe card includes a **Save This Recipe** button. This button is the primary interaction point between your subscribers and crumb. When a subscriber clicks it, crumb records the engagement, tags the subscriber with dietary preferences, and can trigger follow-up sequences.
...
3. **An engagement event is recorded** in crumb's analytics as a "save click."
...
<Aside type="tip">
  The redirect destination gives subscribers a reason to click — they get to see the full recipe on your website. This also drives traffic back to your blog.
</Aside>

## Why Save This Recipe matters

Save clicks are the strongest engagement signal in crumb. They feed into:
...
- **Revenue attribution** — when a subscriber who saved recipes later buys a product, crumb attributes the purchase back to the saved recipes.
...
2. Enable the sequence. crumb creates a default 3-email sequence in Kit:
...
3. You can customize these emails in Kit. crumb creates the drafts; you edit and activate them.

<Aside>
  Subscribers who are already in the sequence will not be re-enrolled. crumb checks for existing enrollment before adding anyone.
</Aside>
